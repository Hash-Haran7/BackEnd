...
# Supabase Session Pooler (password @ encoded as %40)
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    "postgresql://postgres.zkdrlszreqwhmecoyfrg:$u9%40d%40t%40b%40s3oooo@aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres",
)
